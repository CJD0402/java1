...
// Wrapper Class
// 기본형 데이터 타입을 참조형 데이터 타입으로 다루고 싶을 때 사용할 수 있는 클래스
...
// 객체만을 요구하는 상황에서 기본형 데이터 타입을 사용하고 싶을때 사용할 수 있음
...
public class WrapperClass {
	...
	public static void main(String[] args) {
		...
		integer = 20;
		nomalInteger = integer;
		
		// parse 메서드
		// 외부로부터 입력을 받을 때 문자열로 숫자를 받는 경우가 있음
		// 문자열로 숫자를 받을 경우 연산전에 해당 문자열을 숫자 타입으로 변형하기 위해
		// 자주 사용됨
